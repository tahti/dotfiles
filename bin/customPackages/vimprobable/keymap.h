...
Key keys[] = {
    ...
    { 0,                    0,              GDK_t,          scroll,     {ScrollMove     | DirectionBottom   | UnitLine} },
    { 0,                    0,              GDK_c,          scroll,     {ScrollMove     | DirectionTop      | UnitLine} },
    { 0,                    0,              GDK_N,          scroll,     {ScrollMove     | DirectionRight    | UnitLine} },
    ...
    { GDK_CONTROL_MASK,     0,              GDK_h,          scroll,     {ScrollMove     | DirectionTop      | UnitPage} },
    { GDK_CONTROL_MASK,     0,              GDK_n,          scroll,     {ScrollMove     | DirectionBottom   | UnitPage} },
    ...
    { 0,                    0,              GDK_n,          navigate,   {NavigationForward} },
    ...
    { 0,                    0,              GDK_k,          search,     {DirectionNext      | CaseInsensitive   | Wrapping} },
    { 0,                    0,              GDK_K,          search,     {DirectionPrev      | CaseInsensitive   | Wrapping} },

    { 0,                    0,              GDK_colon,      input,      {.s = ":" } },
    { 0,                    0,              GDK_o,          input,      {.s = ":open "} },
    { 0,                    0,              GDK_O,          input,      {.s = ":open ", .i = InsertCurrentURL} },
    { 0,                    0,              GDK_l,          input,      {.s = ":tabopen "} },
    { 0,                    0,              GDK_L,          input,      {.s = ":tabopen ", .i = InsertCurrentURL} },
