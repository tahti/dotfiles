...
if fc==0:
    #print u"{ \"full_text\" : \"0\uf0e0\" , \"color\" : \"#00ff00\", \"separator\":true},"
    f = open(TMP_FILE, 'w')
    f.write(u"{ \"full_text\" : \"\uf0e0\" , \"color\" : \"#00ff00\", \"separator\":true},")
    f.close();
    #print u"{ \"full_text\" : \"0\" , \"color\" : \"\\#00ff00\", \"separator\":true},"
#   print "^ca(1,i3-msg '[title=\"gmail\"] focus')^i(/home/piotr/.i3/icons/email.xpm) 0^ca()"
   #print "^i(/home/piotr/.i3/icons/email.xpm) 0"
    ...
    f = open(TMP_FILE, 'w')
    f.write(u"{ \"full_text\" : \"?\uf0e0\" , \"color\" : \"#ffffff\", \"separator\":true},")
    f.close();
   #print "?"
else:
    f = open(TMP_FILE, 'w')
    f.write(u"{ \"full_text\" : \""+str(fc)+" \uf0e0\" , \"color\" : \"#ff0000\", \"separator\":true},")
    f.close();
